...
final List<Message> recentChats = [
  Message(
    sender: addison,
    avatar: 'asset/images/Addison.jpg',
    time: '01:25',
    text: "typing...",
    unreadCount: 1,
  ),
  ...
  Message(
    sender: deanna,
    avatar: 'asset/images/Deanna.jpg',
    time: '05:26',
    text: "That's so cute.",
    unreadCount: 3,
  ),
  Message(
      sender: nathan,
      avatar: 'asset/images/Nathan.jpg',
      time: '12:45',
...
final List<Message> allChats = [
  Message(
    sender: virgil,
    avatar: 'asset/images/Virgil.jpg',
    time: '12:59',
  ...
  Message(
    sender: stanley,
    avatar: 'asset/images/Stanley.jpg',
    time: '10:41',
    text: "You did what?",
    unreadCount: 1,
    isRead: false,
  ...
  Message(
    sender: leslie,
    avatar: 'asset/images/Leslie.jpg',
    time: '05:51',
    unreadCount: 0,
    isRead: true,
